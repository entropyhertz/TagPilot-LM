...
- **Provider Key Table**: Gemini, Grok, OpenAI, Claude, DeepDanbooru, and WD1.4 sit in one key/status table, so you can see which providers are ready instead of playing API-key hide-and-seek like it is 2009.
